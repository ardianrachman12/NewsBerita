{{-- menampilkan kumpulan berita dari 1 kategori dan 1 vendor berita --}}
<div class="container mb-2" data-aos="fade-up">
    ...
    <div class="row" data-aos="fade-up" data-aos-delay="100">
        <div class="col-lg-9 col-sm-12 col-md-8">
            <div class="row">
                @for ($i = 0; $i < min(12, count($category['data']['posts'])); $i++)
                    @php
                        $post = $category['data']['posts'][$i];
                    @endphp
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="hotel">
                            <div class="hotel-img ratio ratio-16x9" >
                                <img src="{{ $post['thumbnail'] }}" alt="Hotel 1" class="img-fluid" style="object-fit: fill; width: 100%; height: 100%;">
                            </div>
